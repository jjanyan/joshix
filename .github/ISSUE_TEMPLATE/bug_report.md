...
## Is this a joshix issue or a platform issue?
<!-- joshix is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without joshix installed.

     If the problem persists without joshix, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without joshix installed
